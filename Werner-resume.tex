...
\header{steven}{werner}{computer (neuro) scientist} 
...
Elementary Spanish
\section{programming}
{\color{red} $\varheartsuit$} Java Bash \& Python
PHP JS jQuery JSP
Scala C++ MatLab 
Visual Basic AutoIt 
...
\entry
{2018-Present}
{\href{http://www.raytheon.com}{Raytheon: Intelligence, Information Services}}
{Richardson, TX}
{\emph{Science \& Technology: Software Engineer II} \\
...
\begin{itemize}
\item \emph{2018 Authors and Inventors Award} recipient from the IIS Innovation Center for design architecture and implementation contributions to an Internal Research and Development project in my first 6 months
\end{itemize}}
%------------------------------------------------
\entry
{2014-2018}
