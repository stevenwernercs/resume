...
C++ C Objective C
Visual Basic AutoIt 
MatLab VXML {\fontfamily{cmr}\selectfont \LaTeX}
%\end{flushright}
%\end{textblock}
...
\textbf{professional:} general artificial intelligence, biorealistic neural networks, information retrieval, big data representation, neuroscience, blockchain, quantum computing \textbf{personal:} traveling, camping, hiking, percussion, tutoring, dirt biking, mobile app development
