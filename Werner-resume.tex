...
\header{steven}{werner}{software engineer | computer (neuro) scientist | product owner} 
...
Scala MatLab 
Visual Basic AutoIt 
VXML {\fontfamily{cmr}\selectfont \LaTeX}
%\end{flushright}
%\end{textblock}
...
{\color{red} $\varheartsuit$} RHEL Linux \& Mac 
Windows w/ linux WSL
\section{languages}
...
{Richardson, TX}
{\emph{Product Manager/Senior Software Engineer} \\
...
\section{references}
~
\textbf{previous supervisor}
Dr. Mithun Balakrishna
%\href{https://www.linkedin.com/in/mithun-balakrishna-9823b94/}{Dr. Mithun Balakrishna}
Data Science Manager
Amazon
%\href{mailto:bmithuba@amazon.com}{bmithuba@amazon.com}
%Richardson, TX
~
\textbf{previous colleague}
Su Wang
Software Engineer
Google
%\href{mailto: sxw120230@gmail.com}{sxw120230@gmail.com}
%Seattle, WA
~
...
%ISG Labmate / TA
%Google Analytics
%\href{mailto:karkhedkar.shreyas@gmail.com}{karkhedkar.shreyas@gmail.com}
%Mountain View, CA
%~
%Mr. Carlos Luavanos
...
Responsible for maintaining accountability records of all KBR's airfield fuel. 
